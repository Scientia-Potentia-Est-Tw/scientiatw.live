...
<div id="mc_embed_shell">
  ...
  <style type="text/css">
           #mc_embed_signup{background: var(--card-background); clear:left; font:14px Helvetica,Arial,sans-serif; width: 600px; max-width: 100%;}
...
<div id="mc_embed_signup">
    <form action="https://live.us12.list-manage.com/subscribe/post?u=1cb9611c999051fe721263138&amp;id=4574579802&amp;f_id=00f29fe0f0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank">
        <div id="mc_embed_signup_scroll"><h2>訂閱電子報</h2>
            <div class="indicates-required"><span class="asterisk">*</span> 必填 </div>
            <div class="mc-field-group"><label for="mce-EMAIL"> 電子郵件 <span class="asterisk">*</span></label><input type="email" name="EMAIL" class="required email" id="mce-EMAIL" required="" value=""></div><div class="mc-field-group"><label for="mce-FNAME">希望我怎麼稱呼你  <span class="asterisk">*</span></label><input type="text" name="FNAME" class="required text" id="mce-FNAME" required="" value=""></div>
