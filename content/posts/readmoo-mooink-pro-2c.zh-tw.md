...
featureimage = "https://media.secologies.com/Readmoo_mooInk_Pro_2C.webp"
+++
![Readmoo_mooInk_Pro_2C](https://media.secologies.com/Readmoo_mooInk_Pro_2C.webp)
...
![mooink pro 1](https://media.secologies.com/mooinkPro.webp)

![mooink pro 2](https://media.secologies.com/MooinkPro2.webp)
...
![mooink pro 2C](https://media.secologies.com/IMG_0400.webp)
...
![使用《為什麼我們要讀書》展示顏色](https://media.secologies.com/IMG_0402.webp)

![使用《為什麼我們要讀書》展示顏色](https://media.secologies.com/IMG_0401.webp)
...
![使用paper展示黑白效果](https://media.secologies.com/IMG_0403.webp)

![放大效果](https://media.secologies.com/IMG_0404.webp)

13.3吋的大小能夠完全涵蓋A4 PDF的內容，如果是journal的格式像IEEE兩列格式讓字體太小可以用手指滑開放大想要看的內容，另外圖表的顏色也都有清楚顯示，這樣我就可以直接在閱讀器上看這些不同的結果，而不用再回去筆電上看顏色。

![Paper上的顏色效果](https://media.secologies.com/IMG_0405.webp)

另外作為最大的尺寸當然也可以進行雙列並排顯示的功能，可以在mooInk Pro 2C上一次看兩份不同的paper檔案做對比或者是另一邊開啟筆記功能紀錄當下看到的重點。

![並排效果](https://media.secologies.com/IMG_0406.webp)

![並排筆記效果](https://media.secologies.com/IMG_0408.webp)
